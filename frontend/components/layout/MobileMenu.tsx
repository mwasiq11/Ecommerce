      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto">
          ...
          <div className="py-4 px-6 space-y-4">
            <Link to="/user-agreement" onClick={onClose} className="block text-[#1C1C1C] hover:text-primary transition">User agreement</Link>
            <Link to="/partnership" onClick={onClose} className="block text-[#1C1C1C] hover:text-primary transition">Partnership</Link>
            <Link to="/privacy-policy" onClick={onClose} className="block text-[#1C1C1C] hover:text-primary transition">Privacy policy</Link>
          </div>
        </nav>
      </div>
    </>
