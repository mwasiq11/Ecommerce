...
const seedProducts = [
    ...
    { title: 'GoPro HERO6 4K Action Camera - Black', price: 998.00, description: 'Rugged and waterproof action camera for extreme sports and outdoor adventures.', rating: 4.8, orders: 89, shipping: 'Free Shipping', category: 'Computer and tech', brand: 'GoPro', condition: 'Brand new', image: 'https://images.unsplash.com/photo-1526170315870-ef68971ef02f?auto=format&fit=crop&w=500&h=500&q=80', stock: 5 },
    ...
    { title: 'Smart Home Speaker Echo Dot', price: 49.99, description: 'Voice-controlled smart speaker with Alexa assistant integration.', rating: 4.4, orders: 512, shipping: 'Free Shipping', category: 'Computer and tech', brand: 'Amazon', condition: 'Brand new', image: 'https://images.unsplash.com/photo-1589492477829-5e65395b66cc?auto=format&fit=crop&w=500&h=500&q=80', stock: 100 },
